...
class BottomUpIDCardDataset(Kpt2dSviewRgbImgBottomUpDataset):
    """Dataset for ID card keypoint detection.

    The dataset loads raw features and apply specified transforms
    to return a dict containing the image tensors and other information.

    ID card keypoint indexes::
    ...
    def evaluate(self, outputs, res_folder, metric='mAP', **kwargs):
        """Evaluate ID card keypoint results. The pose prediction results will be
