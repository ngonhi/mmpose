...
from mmpose.core import DistEvalHook, EvalHook, DistEvalTrainHook, EvalTrainHook, build_optimizers
...
def train_model(model,
    ...
    if cfg.get('runner') is None:
        cfg.runner = {'type': 'EpochBasedRunner', 'max_iters': cfg.total_epochs}
        warnings.warn(
